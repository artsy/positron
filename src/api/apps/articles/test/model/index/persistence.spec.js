...
describe('Article Persistence', function() {
  ...
  beforeEach(done => empty(() => fabricate('articles', _.times(10, () => ({})), () => done())));

  return describe('#save', function() {

    it('saves valid article input data', done => Article.save({
      title: 'Top Ten Shows',
    ...
    it('adds an updated_at as a date', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018'
    }, 'foo', {}, function(err, article) {
    ...
    it('input updated_at must be a date', function(done) {
      Article.save({
        ...
        author_id: '5086df098523e60002000018',
        updated_at: 'foo'
      }, 'foo', {}, (err, article) => err.message.should.containEql('"updated_at" must be a number of milliseconds or valid date string'));
      return Article.save({
        title: 'Top Ten Shows',
        thumbnail_title: 'Ten Shows',
        author_id: '5086df098523e60002000018',
    ...
    it('includes the id for a new article', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018'
    }, 'foo', {}, function(err, article) {
    ...
    it('adds a slug based off the thumbnail title', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018',
    ...
    it('adds a slug based off a user and thumbnail title', done => fabricate('users', { name: 'Molly'}, function(err, user) {
      this.user = user;
      return Article.save({
    ...
    it('saves slug history when publishing', done => fabricate('users', { name: 'Molly'}, function(err, user) {
      this.user = user;
      return Article.save({
        thumbnail_title: 'Foo Baz',
        author_id: this.user._id.toString(),
    ...
    it('appends the date to an article URL when its slug already exists', done => fabricate('articles', {
      id: '5086df098523e60002002222',
    ...
    it('saves published_at when the article is published', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018',
      published: true,
    ...
    it('updates published_at when admin changes it', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018',
      published: true
      ...
      }, 'foo', {}, function(err, updatedArticle) {
        if (err) { return done(err); }
    ...
    it('saves indexable when the article is published', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018',
      published: true,
    ...
    it('updates indexable when admin changes it', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018'
    }, 'foo', {}, function(err, article) {
    ...
    it('doesnt save a fair unless explictly set', done => Article.save({
      title: 'Top Ten Shows',
      thumbnail_title: 'Ten Shows',
      author_id: '5086df098523e60002000018',
      fair_ids: [],
    ...
    it('escapes xss', function(done) {
      const body = '<h2>Hi</h2><h3>Hello</h3><p><b>Hola</b></p><p><i>Guten Tag</i></p><ol><li>Bonjour<br></li><li><a href="http://www.foo.com">Bonjour2</a></li></ol><ul><li>Aloha</li><li>Aloha Again</li></ul><h2><b><i>Good bye</i></b></h2><p><b><i>Adios</i></b></p><h3>Alfiederzen</h3><p><a href="http://foo.com">Aloha</a></p>';
      const badBody = '<script>alert(foo)</script><h2>Hi</h2><h3>Hello</h3><p><b>Hola</b></p><p><i>Guten Tag</i></p><ol><li>Bonjour<br></li><li><a href="http://www.foo.com">Bonjour2</a></li></ol><ul><li>Aloha</li><li>Aloha Again</li></ul><h2><b><i>Good bye</i></b></h2><p><b><i>Adios</i></b></p><h3>Alfiederzen</h3><p><a href="http://foo.com">Aloha</a></p>';
      return Article.save({
    ...
    it('doesnt escape smart quotes', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('fixes anchors urls', done => Article.save({
      author_id: '5086df098523e60002000018',
      sections: [
        {
          type: 'text',
    ...
    it('retains non-text sections', done => Article.save({
      author_id: '5086df098523e60002000018',
      sections: [
        {
          type: 'text',
    ...
    it('maintains the original slug when publishing with a new title', done => fabricate('users', { name: 'Molly'}, function(err, user) {
      this.user = user;
      return Article.save({
        thumbnail_title: 'Foo Baz',
        author_id: this.user._id.toString(),
    ...
    it('generates keywords on publish', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('indexes the article in elasticsearch on save', done => Article.save({
      author_id: '5086df098523e60002000018',
      title: 'foo article',
      published: true,
      ...
      if (err) { return done(err); }
      return setTimeout( () => search.client.search({
        index: search.index,
        q: 'name:foo'
      }
    ...
    it('saves Super Articles', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('type casts ObjectId over articles', done => Article.save({
      author_id: '5086df098523e60002000018',
      super_article: {
        related_articles: [ '5530e72f7261696238050000' ]
      },
    ...
    it('saves a callout section', done => Article.save({
      author_id: '5086df098523e60002000018',
      sections: [
        {
          type: 'callout',
    ...
    it('saves an article that does not have sections in input', done => fabricate('articles', {
    ...
    it('saves an image set section', done => Article.save({
      author_id: '5086df098523e60002000018',
      sections: [
        {
          type: 'image_set',
    ...
    it('saves social_embed sections', done => Article.save({
      author_id: '5086df098523e60002000018',
      sections: [
        {
          type: 'social_embed',
    ...
    it('saves layouts', done => Article.save({
      author_id: '5086df098523e60002000018',
      layout: 'feature'
    }, 'foo', {}, function(err, article) {
      if (err) { return done(err); }
    ...
    it('it defaults to classic if layout is not specified', done => Article.save({
      author_id: '5086df098523e60002000018'
    }, 'foo', {}, function(err, article) {
      if (err) { return done(err); }
    ...
    it('saves the channel_id', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('saves the partner_channel_id', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('saves the author', done => Article.save({
      author: {
        name: 'Jon Snow',
        id: '5086df098523e60002000018'
      },
    ...
    it('saves the author_ids field', done => Article.save({
    ...
    it('saves a description', done => Article.save({
      author_id: '5086df098523e60002000018',
      channel_id: '5086df098523e60002000015',
    ...
    it('saves a postscript', done => Article.save({
      author_id: '5086df098523e60002000018',
      channel_id: '5086df098523e60002000015',
    ...
    it('saves a media object', done => Article.save({
      author_id: '5086df098523e60002000018',
      media: {duration: 1000}
    }, 'foo', {}, function(err, article) {
      if (err) { return done(err); }
    ...
    it('saves a series description', done => Article.save({
      author_id: '5086df098523e60002000018',
      series: {
    ...
    it('saves a series sub_title', done => Article.save({
      author_id: '5086df098523e60002000018',
      series: {
    ...
    it('saves verticals', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('saves tracking_tags', done => Article.save({
      author_id: '5086df098523e60002000018',
    ...
    it('saves social metadata', done => Article.save({
      author_id: '5086df098523e60002000018',
      channel_id: '5086df098523e60002000015',
    ...
    it('saves search metadata', done => Article.save({
      author_id: '5086df098523e60002000018',
      channel_id: '5086df098523e60002000015',
    ...
    it('saves the seo_keyword', done => Article.save({
      author_id: '5086df098523e60002000018',
      seo_keyword: 'focus'
    }, 'foo', {}, function(err, article) {
      if (err) { return done(err); }
    ...
    it('saves a classic hero_section', done => Article.save({
      hero_section: {
    ...
    it('saves a feature hero_section in fullscreen', done => Article.save({
      hero_section: {
        url: 'http://image.com',
        type: 'fullscreen',
    ...
    it('saves a feature hero_section in text', done => Article.save({
      hero_section: {
        url: 'http://image.com',
        type: 'text',
        deck: 'This year was incredible.'
    ...
    it('saves a feature hero_section in split', done => Article.save({
      hero_section: {
        url: 'http://image.com',
        type: 'split',
        deck: 'This year was incredible.'
    ...
    it('saves a feature hero_section in basic', done => Article.save({
      hero_section: {
        url: 'http://image.com',
        type: 'basic',
        deck: 'This year was incredible.',
    ...
    it('saves a series hero_section', done => Article.save({
      hero_section: {
        url: 'http://image.com',
        type: 'series'
      }
    ...
    it('saves media', done => Article.save({
      media: {
    ...
    it('saves a sponsor', done => Article.save({
      sponsor: {
    ...
    return it('saves a news_source', done => Article.save({
      news_source: {
