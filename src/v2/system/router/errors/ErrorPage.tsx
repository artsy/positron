      ...
      <GridColumns gridRowGap={4}>
        <Column span={6} wrap>
          ...
          <Text variant="sm-display" color="mono60">
            Please contact{" "}
            <Link
              href="mailto:partnersupport@artsy.net"
              style={{ display: "inline" }}
            >
              partnersupport@artsy.net
            </Link>{" "}
            with any questions.
          </Text>
          ...
          {children ?? (
            <Text variant="sm-display" color="mono60" mt={2}>
              <Link href={getENV("VOLT_V1_URL")}>Go to CMS Homepage</Link>
            </Text>
          )}
        </Column>
      </GridColumns>
...
const Message = styled(Code).attrs<any>({
  border: "1px solid",
  borderColor: "mono10",
  px: 1,
  py: 0.5,
...
const Detail = styled(Code).attrs<any>({
  border: "1px solid",
  borderColor: "mono10",
  px: 1,
  py: 0.5,
