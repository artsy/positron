...
import {
  blockTypes,
  inlineStyles,
} from "client/apps/edit/components/content/sections/text/draft_config.js"
...
describe("TextNav", () => {
  ...
  describe("Rendering", () => {
    ...
    it("renders no buttons by default", () => {
      const component = mount(<TextNav {...props} />)
