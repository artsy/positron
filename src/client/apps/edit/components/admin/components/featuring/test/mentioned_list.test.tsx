...
describe("MentionedList", () => {
  ...
  const getWrapper = (passedProps = props) => {
    ...
    const { article, mentioned } = passedProps
  ...
  it("Calls #getMentionedArtists on mount if model is artist", () => {
    const component = getWrapper()
      .find(MentionedList)
      .instance() as MentionedList
    component.getMentionedArtists = jest.fn()
    component.componentWillMount()
    expect(component.getMentionedArtists).toBeCalled()
  })
  ...
  it("Calls #getMentionedArtworks on mount if model is artwork", () => {
    ...
    const component = getWrapper(props)
      .find(MentionedList)
      .instance() as MentionedList
    component.getMentionedArtworks = jest.fn()
    component.componentWillMount()
    expect(component.getMentionedArtworks).toBeCalled()
  })
  ...
  it("#isFeatured returns true if item _id is already featured", () => {
    ...
    const component = getWrapper(props)
      .find(MentionedList)
      .instance() as MentionedList
    const isFeatured = component.isFeatured(props.mentioned.artist[0]._id)
  ...
  it("#notFeaturedArray returns array of mentioned items that are not featured", () => {
    ...
    const component = getWrapper(props)
      .find(MentionedList)
      .instance() as MentionedList
    const notFeaturedArray = component.notFeaturedArray()
