...
describe("SectionText", () => {
  ...
  describe("Mount and Display", () => {
    ...
    it("Converts html onChange with only plugin supported classes", () => {
      ...
      props.section.body =
        '<p class="cool-thing">Cool thing. </p><h2><span><a href="https://www.artsy.net/artist/kow-hiwa" class="is-follow-link">solo show</a><a data-id="kow-hiwa" class="entity-follow artist-follow"></a></span></h2>'
      const component = getWrapper(props)
  ...
  describe("#onPaste", () => {
    ...
    it("Strips google inserted styles", () => {
      ...
      expect(component.state().html).toBe(
        "<p>Available at: Espacio Valverde • Galleries Sector, Booth 9F01</p>"
      )
    })
