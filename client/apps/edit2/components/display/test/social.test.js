...
describe('DisplaySocial', () => {
  ...
  beforeEach(() => {
    ...
    props.article.social_image = 'https://artsy-media-uploads.s3.amazonaws.com/-El3gm6oiFkOUKhUv79lGQ%2Fd7hftxdivxxvm.cloudfront-6.jpg'
    props.article.social_title = 'Virtual Reality Is the Most Powerful Artistic Medium of Our Time'
  })
  ...
  it('Can change the description', () => {
    ...
    expect(props.onChangeArticleAction.mock.calls[0][0]).toBe('social_description')
