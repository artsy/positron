...
export const ModalTypes = {
  'locked': {
    ...
    description: (time, name) => `Only one user is allowed to edit an article at a time. 
  ...
  'timeout': {
    ...
    description: (time, name) => `Users are redirected from editing an article after 10 minutes
