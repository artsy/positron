...
describe "Article", ->
  ...
  describe 'slugsFromHTML', ->
    ...
    it 'extracts a slug from an Artsy link', ->
      ...
      @section.slugsFromHTML(@section.get('body'),'artist')[0].should.equal 'kana-abe'
    ...
    it 'extracts a slug from a Google link', ->
      ...
      @section.slugsFromHTML(@section.get('body'),'artist')[0].should.equal 'trenton-doyle-hancock'
