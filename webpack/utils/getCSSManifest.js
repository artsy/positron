...
function compile() {
  console.log(chalk.green(`[Positron compileCSS] Compiling...`))
...
function fingerprint(file) {
  ...
  try {
    ...
    console.error("[Positron compileCSS] Error renaming file:", error)
  }
...
exports.getCSSManifest = () => {
  try {
    ...
    console.log(chalk.green(`[Positron compileCSS] Complete.`))
    return manifest
  } catch (error) {
    console.error(chalk.red("[Positron compileCSS] Error:", error))
    process.exit(1)
  }
}
